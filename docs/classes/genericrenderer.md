...
# Class: GenericRenderer<ValueI, NodeI, OutputI\>
...
* [Registry](registry.md)<ValueI, NodeI\>
...
\+ **new GenericRenderer**(...`sets`: [Registry](registry.md)<ValueI, NodeI\>[]): [GenericRenderer](genericrenderer.md)
...
▸ **render**(`factory`: [XmlRendererFactory](../README.md#xmlrendererfactory)<ValueI, NodeI, OutputI\>, `node`: NodeI, ...`rest`: [XmlRendererRestArguments](../README.md#xmlrendererrestarguments)): OutputI

*Defined in [GenericRenderer.ts:74](https://github.com/wvbe/xml-renderer/blob/3ae94aa/src/GenericRenderer.ts#L74)*
